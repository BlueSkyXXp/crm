  ...
  <TablePanel title="日来访详情">
    ...
    <div slot="content">
      ...
      <el-table v-loading="loading" :data="visitList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="来访时间" align="center" prop="createTime" />
...
<script>
import {listVisit, getVisit, delVisit, addVisit, updateVisit, listVisitDetail} from "@/api/crm/visit";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listVisitDetail(this.queryParams).then(response => {
