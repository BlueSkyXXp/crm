  ...
  <st-table-panel>
    <div slot="search">
      <el-form v-show="showSearch" ref="queryForm" :model="queryParams" label-position="right" :inline="true" label-width="150px">
        ...
        <el-form-item label="星级" prop="level">
          <el-select v-model="queryParams.level" placeholder="请选择星级" style="width: 240px">
            <el-option
        ...
        <el-form-item label="来源" prop="source">
          <el-select v-model="queryParams.source" placeholder="请选择来源" style="width: 240px">
            <el-option
        ...
        <el-form-item label="贷款条件" class="flex">
          <div class="flex">
            <el-select v-model="loanValue" placeholder="请选择" style="width: 100px">
              <el-option
        ...
        <el-form-item label="时间类型" prop="customerId" class="flex">
          <div class="flex">
            <el-select v-model="timeValue" placeholder="请选择" style="width: 130px">
              <el-option
    ...
    <div slot="content">
      <el-table v-loading="loading" border :height="tableHeight" :data="customerList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="顾问" align="center" prop="userId" />
