...
<script>
import { listResignCustomer, getCustomer, delCustomer, addCustomer, updateCustomer, assignCustomer } from "@/api/crm/customer";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listResignCustomer(this.queryParams).then((response) => {
