<template>
  <div :class="wrapper">
    ...
    <template v-if="!onlyProvince">
      <el-select v-model="currentCity" style="margin-left: 5px;" :disabled="disabled || cityDisabled" placeholder="市" @change="getAreas">
        <el-option
      ...
      <el-select v-if="!hideArea" v-model="currentArea" style="margin-left: 5px;" :disabled="disabled || areaDisabled" placeholder="区">
        <el-option
